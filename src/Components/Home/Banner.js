        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 w-full md:w-[90%] lg:w-[75%] px-2">
          <div>
            ...
            <p className="py-6 hero-text-p text-text white">
              Transform your business with innovative strategies and tailored digital solutions. We craft experiences that help you stand out in the competitive market and drive success
            </p>
          </div>
      ...
      <div className="creative-design py-3 ">
        <div className="hero potentials">
          <div className="mx-auto w-full md:w-[90%] lg:w-[75%] px-2 py-4 grid grid-cols-1 lg:grid-cols-2">
            <div>
              <h1 className="text-6xl font-bold text-white potential-text-head pl-1">
                Unlock The <span className="potential">Potential</span> Of{" "}
                <br />
                Your Business.
              </h1>
              <p className="py-6 potential-text-p pl-1">
                Unlock growth opportunities with customized strategies that highlight your business’s strengths. From creative design to strategic rebranding, we help build a lasting identity.
              </p>
              <hr />
              <div class="grid grid-cols-1 md:grid-cols-2 mt-[10px]">
