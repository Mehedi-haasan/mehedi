  ...
  return (
    <div name='about'>
      <div className='bg-black py-5 md:ml-0'>
        ...
        <h1 className='text-white text-2xl lg:text-5xl font-bold text-center py-5 g:py-10'>How I Work</h1>
        ...
        <div className='grid grid-cols-10 w-full pb-10 md:w-[90%] lg:w-[75%] mx-auto text-white gap-2'>
          ...
          <div className='grid col-span-10 lg:col-span-2'>
            ...
            <h1 className='text-lg p-3 font-semibold text-center'>Maintenance And Support.</h1>
            <p className='p-3 text-[#b5b5b5] text-center '>Interdum et malesuada fames acchiv Etiam europeat nibhona elementum, accumsan ona.</p>
          </div>
